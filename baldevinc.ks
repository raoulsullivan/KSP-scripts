...
print "T+" + round(missiontime) + " Relative inclination " + round(inc,1).
if inc > 90 {
...
print "Angle to burn:" +aburn.
set smas to ps:mag.                       
set ops to 2*constant():pi*sqrt(smas^3/(ship:obt:body:mass*constant():g)).         // ship orbital period
